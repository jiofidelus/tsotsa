...
<p>
  ...
  With any valid license key it will also work at the "localhost" domain, which is useful when debugging and testing.
</p>
<p>
...
<p>
  ...
  <code>go-debug.js</code>, but only with GoJS version 1.8 or later.
...
<p>
  You can download the <code>go.js</code> or <code>go-debug.js</code> library 
  from the <a href="../download.html" target="_blank">GoJS Downloads page</a>,
  or you can install it using <a href="https://www.npmjs.com/package/gojs" target="_blank">Node package manager (npm)</a>,
  or you can link to a CDN such as <a href="https://unpkg.com/browse/gojs/" target="_blank">UNPKG</a>
  or <a href="https://www.jsdelivr.com/package/npm/gojs">JSDELIVR</a>.
</p>
...
<p>
  When building a desktop application using Electron or when hosted in a WebView as part of a desktop application,
