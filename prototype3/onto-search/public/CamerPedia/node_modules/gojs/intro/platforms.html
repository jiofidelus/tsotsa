...
<!-- Copyright 1998-2021 by Northwoods Software Corporation. -->    <title> GoJS on Different Platforms -- Northwoods Software </title>
...
<p>
  We provide samples and components for common SPA frameworks.
...
<p>
  ...
  Note that an unlimited domains license is required for use when the page is not served from a domain.
</p>

<h2>Node.js and Headless Environments</h2>
<p>
  GoJS can be used in environments that do not have a DOM.
  This can be useful for server  We provide a <a href="https://gojs.net/latest/intro/nodeScript.html">Node.js script example</a>.
  We also have a Puppeteer example in the <a href="serverSideImages.html">Server-side images intro page</a>.
</p>
